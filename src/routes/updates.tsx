...
export const Route = createFileRoute("/updates")({
  head: () => ({
    meta: [
      { title: "Updates — Pulse" },
      { name: "description", content: "Pulse updates: a livelier, more expressive way to message." },
      { property: "og:title", content: "Updates — Pulse" },
      { property: "og:description", content: "Pulse updates: a livelier, more expressive way to message." },
